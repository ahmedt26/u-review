...
?>
    ...
    <head>
        <!-- Metadata of Website -->
        <!-- Dynamically generate  title of the page using the name of the location. -->
...
-->
  ...
  -->
        ...
        <form name="writeAReview" action="writereview.php?location_id=<?php echo $rowInfo['id'] ?>" method="GET">
